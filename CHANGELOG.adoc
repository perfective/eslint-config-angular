...
== v0.16.0-alpha.1 (next)

* Updated `link:https://github.com/perfective/eslint-config[@perfective/eslint-config]` to `link:https://github.com/perfective/eslint-config/releases/tag/v0.20.0-alpha.1[0.20.0-alpha.1]`.
+
* Updated `@angular-eslint` to `15.1.0`.
